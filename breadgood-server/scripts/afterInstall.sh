docker pull bell2017/dockerhub:latest
docker run --env-file /home/ubuntu/.env --publish 8080:8080 -it --detach --name breadgood-test bell2017/dockerhub:latest /bin/bash
